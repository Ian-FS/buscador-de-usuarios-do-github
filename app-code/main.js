...
console.log(
  document.querySelector("#icone").children[0].children[0].attributes[1].value
);
...
function alteraTema() {
  if (tema.children[0].innerHTML === "DARK") {
    ...
    document.querySelector(
      "#icone"
    ).children[0].children[0].attributes[1].value = "#FFFFFF";
    document.querySelector(
      "#icone"
    ).children[0].children[0].attributes[0].value =
